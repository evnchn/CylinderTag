...
parser.add_argument('--gap', type=float, default=0.5, help='Gap between images in cm (default: 0.5)')
...
parser.add_argument('--label_gap', type=int, default=30, help='Vertical gap between image and label in pixels (default: 10)')
